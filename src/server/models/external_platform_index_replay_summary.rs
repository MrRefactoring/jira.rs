...
pub struct ExternalPlatformIndexReplaySummary {
    #[serde(rename = "lastConsumedOperation", default, skip_serializing_if = "Option::is_none")]
    pub last_consumed_operation: Option<ExternalPlatformIndexReplayEntry>,
    #[serde(rename = "lastOperationInQueue", default, skip_serializing_if = "Option::is_none")]
    pub last_operation_in_queue: Option<ExternalPlatformIndexReplayEntry>,
