...
crate::open_enum! {
    ...
    pub enum MultiDirectoryUserDetailsDataManagementSource {
        Invited => "invited",
        Synced => "synced",
    }
}
...
#[non_exhaustive]
pub struct MultiDirectoryUserDetailsData {
    ...
    pub management_source: Option<MultiDirectoryUserDetailsDataManagementSource>,
