...
pub struct TargetToSourcesMapping {
    ...
    #[serde(rename = "targetClassification", default, skip_serializing_if = "Option::is_none")]
    pub target_classification: Option<Vec<TargetClassification>>,
    ...
    #[serde(rename = "targetMandatoryFields", default, skip_serializing_if = "Option::is_none")]
    pub target_mandatory_fields: Option<Vec<TargetMandatoryFields>>,
    ...
    #[serde(rename = "targetStatus", default, skip_serializing_if = "Option::is_none")]
    pub target_status: Option<Vec<TargetStatus>>,
}
