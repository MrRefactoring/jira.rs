...
crate::open_enum! {
    pub enum GetProjectVersionsPaginatedRequestExpandVariant2 {
...
crate::open_enum! {
    pub enum GetProjectVersionsPaginatedRequestExpandUnion3 {
        Issuesstatus => "issuesstatus",
        Operations => "operations",
        Driver => "driver",
        Approvers => "approvers",
...
crate::open_enum! {
    pub enum GetProjectVersionsRequestExpandVariant2 {
        Operations => "operations",
    }
}

crate::open_enum! {
    pub enum GetProjectVersionsRequestExpandUnion3 {
        Operations => "operations",
    }
}
...
crate::open_enum! {
    pub enum GetVersionRequestExpandVariant2 {
        Operations => "operations",
        Issuesstatus => "issuesstatus",
        Driver => "driver",
        Approvers => "approvers",
...
crate::open_enum! {
    pub enum GetVersionRequestExpandUnion3 {
        Operations => "operations",
        Issuesstatus => "issuesstatus",
        Driver => "driver",
        Approvers => "approvers",
