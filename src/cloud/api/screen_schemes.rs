...
crate::open_enum! {
    pub enum GetScreenSchemesRequestExpandVariant2 {
        IssueTypeScreenSchemes => "issueTypeScreenSchemes",
    }
}

crate::open_enum! {
    pub enum GetScreenSchemesRequestExpandUnion3 {
        IssueTypeScreenSchemes => "issueTypeScreenSchemes",
    }
}
...
pub enum GetScreenSchemesRequestExpand {
    Variant0(String),
    Variant1(Vec<String>),
    Variant2(GetScreenSchemesRequestExpandVariant2),
    Variant3(Vec<GetScreenSchemesRequestExpandUnion3>),
}
