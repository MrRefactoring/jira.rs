...
crate::open_enum! {
    pub enum CreateFilterRequestExpandVariant2 {
...
crate::open_enum! {
    pub enum CreateFilterRequestExpandUnion3 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum GetFavouriteFiltersRequestExpandVariant2 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum GetFavouriteFiltersRequestExpandUnion3 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum GetMyFiltersRequestExpandVariant2 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum GetMyFiltersRequestExpandUnion3 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum GetFiltersPaginatedRequestExpandVariant2 {
        Description => "description",
        Favourite => "favourite",
...
crate::open_enum! {
    pub enum GetFiltersPaginatedRequestExpandUnion3 {
        Description => "description",
        Favourite => "favourite",
        FavouritedCount => "favouritedCount",
        Jql => "jql",
...
crate::open_enum! {
    pub enum GetFilterRequestExpandVariant2 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum GetFilterRequestExpandUnion3 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum UpdateFilterRequestExpandVariant2 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum UpdateFilterRequestExpandUnion3 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum SetFavouriteForFilterRequestExpandVariant2 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum SetFavouriteForFilterRequestExpandUnion3 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum DeleteFavouriteForFilterRequestExpandVariant2 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
...
crate::open_enum! {
    pub enum DeleteFavouriteForFilterRequestExpandUnion3 {
        SharedUsers => "sharedUsers",
        Subscriptions => "subscriptions",
    }
}
