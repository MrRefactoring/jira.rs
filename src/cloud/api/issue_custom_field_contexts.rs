...
impl<'a> GetContextsForFieldRequest<'a> {
    ...
    /// required.
    pub fn stream(self) -> futures_util::stream::BoxStream<'a, crate::core::Result<CustomFieldContext>> {
...
impl<'a> GetContextDefaultValuesRequest<'a> {
    ...
    /// it needs `TryStreamExt` in scope, re-exported as [`crate::futures_util`] so no dependency of your own is
    /// required.
    pub fn stream(self) -> futures_util::stream::BoxStream<'a, crate::core::Result<ContextDefaultValues>> {
        let first = self.start_at.unwrap_or(0);
...
impl<'a> GetIssueTypeMappingsForContextsRequest<'a> {
    ...
    /// it needs `TryStreamExt` in scope, re-exported as [`crate::futures_util`] so no dependency of your own is
    /// required.
    pub fn stream(self) -> futures_util::stream::BoxStream<'a, crate::core::Result<IssueTypeToContextMapping>> {
        let first = self.start_at.unwrap_or(0);
...
impl<'a> GetCustomFieldContextsForProjectsAndIssueTypesRequest<'a> {
    ...
    /// it needs `TryStreamExt` in scope, re-exported as [`crate::futures_util`] so no dependency of your own is
    /// required.
    pub fn stream(self) -> futures_util::stream::BoxStream<'a, crate::core::Result<ContextForProjectAndIssueType>> {
        let first = self.start_at.unwrap_or(0);
...
impl<'a> GetProjectContextMappingRequest<'a> {
    ...
    /// it needs `TryStreamExt` in scope, re-exported as [`crate::futures_util`] so no dependency of your own is
    /// required.
    pub fn stream(self) -> futures_util::stream::BoxStream<'a, crate::core::Result<CustomFieldContextProjectMapping>> {
        let first = self.start_at.unwrap_or(0);
