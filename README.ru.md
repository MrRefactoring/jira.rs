...
> конвейером, что и `jira.js`, поэтому разойтись библиотеки могут только в языке. Пятьсот живых тестов идут против
> реального сайта Jira и Data Center в Docker — именно они нашли дефекты, которых не видит компилятор.
